...
SECRET_KEY = 'django-insecure-**k5ip^x**!=w$h=37w^w-==+!j*v_(l8#1w=@ne^b7(^b&$^@'
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': (
        'rest_framework.renderers.JSONRenderer',  # Ensures that the renderer is set to JSON
    ),
    'DEFAULT_PARSER_CLASSES': (
        'rest_framework.parsers.JSONParser',  # Ensures that the parser is JSON
    ),
